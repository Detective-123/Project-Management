...
1. SEND EMAIL AFTER CREATING A NEW PROJECT
2. SEND EMAIL AFTER ADDING NEW USER TO A PROJECT
*/
...
const updateMemberRoles = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, projectMember, "Updated member roles"));
});
